...
\begin{center}
	\begin{figure}[H]
		\centering
		\subfloat[\centering DAE Still Frame]{{\includegraphics[width=8cm]{DAE_SF_2_anno} }}%\\
		
		\subfloat[\centering EL Still Frame]{{\includegraphics[width=8cm]{EL_SF_2_anno} }}%\\
...
\begin{center}
	\begin{figure}[H]
		\centering
		\subfloat[\centering DAE Still Frame]{{\includegraphics[width=8cm]{DAE_SF_1} }}%\\
		
		\subfloat[\centering EL Still Frame]{{\includegraphics[width=8cm]{EL_SF_1} }}%\\
