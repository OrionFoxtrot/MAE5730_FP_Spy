...
% X0_0 = [0,2.1]; % x1 y1
% X0_1 = [0,2.1-d1,0]; %x2 y2 theta1
% X0_2 = [0,2.1-d1-d2,0]; %x3 y3 theta2
% X0_3 = [0,2.1-d1-d2-d3,0]; %x4 y4 theta3

X0_0 = [1,2*cos(1/3)]; % x1 y1
X0_1 = [1,2*cos(1/3)-d1/2,0]; %x2 y2 theta1
X0_2 = [1,2*cos(1/3)-d1-d2/2,0]; %x3 y3 theta2
X0_3 = [1,2*cos(1/3)-1-d1-d2-d3/2,0]; %x4 y4 theta3
...
%A = DAE_A_funs(D1,D2,D3,IG1,IG2,IG3,M1,M2,M3,M4,THETA1,THETA2,THETA3,Y1)
